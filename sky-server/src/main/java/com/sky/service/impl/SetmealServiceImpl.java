...
public class SetmealServiceImpl implements SetmealService {
    ...
    public List<Setmeal> getByCategory(Integer categoryId) {
        ...
        List<Setmeal> list = setmealMapper.getByCategoryId(Long.valueOf(categoryId));
        return list;
    }

    @Override
    public List<DishItemVO> GetDishesBySetmeal(Long id) {
        List<DishItemVO> list = setMealDishMapper.GetDishesBySetmeal(id);
        return list;
    }
}
